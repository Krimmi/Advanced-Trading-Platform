...
from src.ml_models.price_prediction.config.config import TRANSFORMER_CONFIG, get_config
...
class TransformerPriceModel(BasePriceModel):
    """
    Transformer model for stock price prediction.
    """
    def __init__(
        self,
        model_name: str = "transformer_price_model",
        ...
        """
        Initialize the Transformer price prediction model.
        ...
        # Get configuration
        self.config = config or get_config("transformer")["model"]
    ...
    def build_model(self) -> tf.keras.Model:
        ...
        # Create the model
        inputs = Input(shape=(self.input_window_size, n_features))
        ...
        for _ in range(num_encoder_layers):
            x = TransformerBlock(d_model, nhead, dim_feedforward, dropout)(x)
        ...
        self.logger.info(f"Transformer model built with {num_encoder_layers} encoder layers")
        return model
    ...
    def save_model(self, path: Optional[str] = None) -> str:
        ...
        self.logger.info(f"Transformer model saved to {model_file}")
        return save_path
    ...
    def load_model(self, path: Optional[str] = None) -> None:
        ...
        try:
            # Need to define the custom layer before loading
            ...
            self.logger.info(f"Transformer model loaded from {model_file}")
